...
$hs = mysqli_query($host, "SELECT * FROM tb_absen_harian INNER JOIN tb_siswa ON tb_siswa.nis = tb_absen_harian.nis WHERE tb_absen_harian.id_kelas = '$kelas' AND DATE(tb_absen_harian.timestamp) = '$date' AND NOT status_absen = 4");
  ...
  <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              Absensi Untuk Kelas : <?= $kelas ?>
                </h6>
              
            </div>
            <div class="card-body">

            <h3>Absensi Harian untuk tanggal <?= $date ?></h3>
                ...
                <tr>
                    ...
                    <table class="w-100">
                        <tr>
                            ...
                            <td><input type="radio" name="status_hadir" value="hadir" <?= $data["status_absen"] == "Hadir" ? "checked" : "" ?>></td>
                            <td><input type="radio" name="status_hadir" value="hadir_t" <?= $data["status_absen"] == "Hadir(Telat)" ? "checked" : "" ?>></td>
                            <td><input type="radio" name="status_hadir" value="tidak_h" <?= $data["status_absen"] == "Tidak Hadir" ? "checked" : "" ?>></td>
                            </form>
                        </tr>
                        </table>
                    </td>
    ...
    <script>
      ...
      $('#cobaStatus').click(function(){
        ...
        $.ajax({
            type: 'POST',
            url: 'absen_harian_aksi_update.php',
