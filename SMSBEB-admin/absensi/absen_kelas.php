      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <?php $tQ = mysqli_query($host, "SELECT * FROM tb_kelas"); while($data = mysqli_fetch_array($tQ)){ ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h6>Absensi Kelas <?= $data["nama_kelas"] ?></h6>
                        </div>
                        <div class="col-md-4">
                            <a href="absen_pelajaran_index.php?id_kelas=<?= $data["id_kelas"] ?>" class="btn btn-info">Detail</a>
                        </div>
                    </div>
