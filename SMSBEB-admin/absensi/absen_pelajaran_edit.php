        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="tanggal" value="<?= $tanggalEdit ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <?php   $tKela = mysqli_fetch_array(mysqli_query($host, "SELECT * FROM tb_mapel WHERE id_mapel = '$rKelas'")); ?>
                ...
                <?php
                    $hs = mysqli_query($host, "SELECT * FROM tb_absen_pelajaran INNER JOIN tb_siswa on tb_siswa.nis = tb_absen_pelajaran.nis INNER JOIN tb_kelas on tb_kelas.id_kelas = tb_siswa.id_kelas WHERE tb_kelas.id_kelas = '$kelas' AND DATE(tb_absen_pelajaran.timestamp) = '$tanggalEdit' AND id_mapel = '$rKelas' ");
                ...
                <tr>
                    ...
                    <table class="w-100">
                        <tr>
                            ...
                            <input type="text" name="timestamp" hidden value="<?= $data["timestamp"] ?>">
                            <input type="text" name="nis" hidden value="<?= $data["nis"] ?>">
                            <td><input type="radio" name="status_hadir" value="hadir" <?= $data["status"] == "Hadir" ? "checked" : "" ?>></td>
                            <td><input type="radio" name="status_hadir" value="sakit" <?= $data["status"] == "Sakit" ? "checked" : "" ?>></td>
                            <td><input type="radio" name="status_hadir" value="izin" <?= $data["status"] == "Izin" ? "checked" : "" ?>></td>
                            <td><input type="radio" name="status_hadir" value="alpha" <?= $data["status"] == "Alpha" ? "checked" : "" ?>></td>
                            </form>
                        </tr>
                        </table>
                    </td>
      ...
      var array_Holder = [];
        $(document).ready(function(){
            $('#cobaStatus').click(function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'absen_pelajaran_edit_aksi.php',
